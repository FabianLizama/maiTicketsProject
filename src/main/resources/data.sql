...
INSERT INTO public.leadership(id_leadership, email, name, password) VALUES (5,'FERNANDO SOLÍS LEADERSHIP', 'FERNANDO_SOLÍS_L@maitickets.com', '1234');
...
INSERT INTO public.leadership(id_leadership, email, name, password) VALUES (7,'NICOLÁS AGUILERA LEADERSHIP', 'NICOLÁS_AGUILERA_L@maitickets.com', '1234');
...
INSERT INTO public.leadership(id_leadership, email, name, password) VALUES (9,'FABIÁN LIZAMA LEADERSHIP', 'FABIÁN_LIZAMA_L@maitickets.com', '1234');

INSERT INTO public.leadership(id_leadership, email, name, password) VALUES (10,'Leadership Name', 'Leadership@maitickets.com', '1234');

INSERT INTO public.analyzer (id_analyzer, email, name, password, id_leadership) VALUES (1, 'FABIÁN_LIZAMA@maitickets.com', 'FABIÁN LIZAMA', '1234', 1);
...
INSERT INTO public.analyzer (id_analyzer, email, name, password, id_leadership) VALUES (3, 'NICOLÁS_AGUILERA@maitickets.com', 'NICOLÁS AGUILERA', '1234', 3);

INSERT INTO public.analyzer (id_analyzer, email, name, password, id_leadership) VALUES (4, 'FERNANDO_SOLÍS@maitickets.com', 'FERNANDO SOLÍS', '1234', 4);
...
INSERT INTO public.academic_unit (id_academic_unit, name, id_leadership) VALUES (1, 'Departamento de Informática', 1);

INSERT INTO public.academic_unit (id_academic_unit, name, id_leadership) VALUES (2, 'Facultad de Ciencias Sociales', 2);

INSERT INTO public.academic_unit (id_academic_unit, name, id_leadership) VALUES (3, 'Facultad de Ingeniería', 3);

INSERT INTO public.academic_unit (id_academic_unit, name, id_leadership) VALUES (4, 'Facultad de Matemáticas', 4);
...
INSERT INTO public.academic_unit (id_academic_unit, name, id_leadership) VALUES (7, 'Departamento de Física', 7);

INSERT INTO public.academic_unit (id_academic_unit, name, id_leadership) VALUES (8, 'Escuela de Artes y Oficio', 8);

INSERT INTO public.academic_unit (id_academic_unit, name, id_leadership) VALUES (9, 'Departamento de Biología', 9);
...
INSERT INTO public.client(id_client, email, last_namem,last_namep,name, password, rut) VALUES (2,'diego@gmail.com','Fernández', 'Valdés','Diego', '1234','20847708-0');
